...
class SongInfo(
    ...
    var lrclist: MutableList<KuwoSongInfo.Data.Lrclist>? = emptyList<KuwoSongInfo.Data.Lrclist>().toMutableList(),
    var abslist: NewKuwoMusicModel.Abslist? = NewKuwoMusicModel.Abslist(),
    var lyric: String? = "",
    var translateLyric: String? = "",
