...
class LunarCalender {
     ...
     * @return
     */
    var lunarMonth: String? = null // 农历的月份
...
//        return "农历 "+lunM+lunD+" "+Festival;
    ...
    fun getConstellation(month: Int, day: Int): String { //计算星座
        ...
        var constellation = ""
        constellation = if (date in 120..218) {
            constellations[1]
        } else if (date in 219..320) {
            constellations[2]
        } else if (date in 321..419) {
            constellations[3]
        } else if (date in 420..520) {
            constellations[4]
        } else if (date in 521..620) {
            constellations[5]
        } else if (date in 621..721) {
            constellations[6]
        } else if (date in 722..822) {
            constellations[7]
        } else if (date in 823..922) {
            constellations[8]
        } else if (date in 923..1022) {
            constellations[9]
        } else if (date in 1023..1121) {
            constellations[10]
        } else if (date in 1122..1221) {
            constellations[11]
        } else {
            constellations[0]
        }
    ...
    fun getyiji(year: Int, month: Int): ArrayList<String?> {
        ...
        for (i in 0 until days_of_month) {
            ...
            var str = CalConv2(
                num_y % 12, num_m % 12, num_d % 12, num_y % 10, num_d % 10, mLMonth, mLDay - 1
            )
            if (str == null) {
