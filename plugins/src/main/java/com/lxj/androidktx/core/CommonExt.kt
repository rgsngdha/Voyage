...
fun Context.createDrawable(color: Int = Color.TRANSPARENT, radius: Float = 0f, cornerRadiusArray: Array<Float>? = null,
    ...
    val d: Drawable = GradientDrawable().apply {
        cornerRadius = radius
...
/** json相关 **/
fun Any.toJson(dateFormat: String = "yyyy-MM-dd HH:mm:ss", lenient: Boolean = false, excludeFields: List<String>? = null): String = GsonBuilder().setDateFormat(dateFormat)
        .apply {
