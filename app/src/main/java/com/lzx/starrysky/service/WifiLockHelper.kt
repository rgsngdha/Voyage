...
object WifiLockHelper {
    ...
    fun acquire(context: Context) {
        if (isWifiConnected(context) && mWifiLock == null) {
            ...
            context.getSystemService(PowerManager::class.java)?.let {
                mCellularLock =
                    it.newWakeLock(PowerManager.PARTIAL_WAKE_LOCK, "WifiLockHelper Lock_Cellular")
    ...
    private fun isWifiConnected(context: Context): Boolean {
        ...
        return cm?.activeNetworkInfo?.type == ConnectivityManager.TYPE_WIFI && cm.activeNetworkInfo?.isAvailable == true
    }
