...
class CustomNotification constructor(
    ...
    private fun createNotification(): Notification? {
        ...
        val smallIcon = if (config.smallIconRes != -1) config.smallIconRes else R.drawable.outline_music_note_24
        //适配8.0
    ...
    private fun updateRemoteViewUI(
        ...
        if (art == null) {
            ...
            if (fetchArtUrl.isNullOrEmpty()) {
                art = BitmapFactory.decodeResource(context.resources, R.drawable.umeng_socialize_share_music)
            }
        }
        if (art != null) {
