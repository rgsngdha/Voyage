...
@Deprecated(
    "registerForStartActivityResult(callback) instead.", ReplaceWith(
        "registerForStartActivityResult(callback)",
        "com.dylanc.longan.activityresult.registerForStartActivityResult"
    )
)
...
@Deprecated(
    "registerForStartIntentSenderResult(callback) instead.", ReplaceWith(
        "registerForStartIntentSenderResult(callback)",
        "com.dylanc.longan.activityresult.registerForStartIntentSenderResult"
    )
)
...
@Deprecated(
    "registerForRequestPermissionResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForRequestMultiplePermissionsResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForTakePicturePreviewResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForTakePictureResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForTakeVideoResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForPickContactResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForPickContentResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForGetContentResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForGetMultipleContentsResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForOpenDocumentResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForOpenMultipleDocumentsResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForOpenDocumentTreeResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForCreateDocumentResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForLaunchAppSettingsResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForLaunchNotificationSettingsResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForCropPictureResult(callback) instead.", ReplaceWith(
...
@Deprecated(
    "registerForEnableLocationResult(onLocationEnabled) instead.", ReplaceWith(
...
@RequiresPermission(Manifest.permission.BLUETOOTH)
@Deprecated(
    "registerForEnableBluetoothResult(onBluetoothEnabled) instead.", ReplaceWith(
...
@Deprecated(
    "registerForLaunchWifiSettingsResult(callback) instead.", ReplaceWith(
