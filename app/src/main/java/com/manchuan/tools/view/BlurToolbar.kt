...
class BlurToolbar @JvmOverloads constructor(
    context: Context,
    ...
    private fun Bitmap.withinBounds(): Bitmap {
        return Bitmap.createBitmap(
            ...
            this@BlurToolbar.width.sampleScaled,
            this@BlurToolbar.height.sampleScaled
        )
    }
    ...
    private inline val Bitmap.asRoundedDrawable: Drawable
        get() = RoundedBitmapDrawableFactory.create(resources, this).apply {
            cornerRadius = this@BlurToolbar.cornerRadius.toFloat()
        }
}