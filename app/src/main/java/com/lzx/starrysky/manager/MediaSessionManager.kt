...
class MediaSessionManager(
    ...
    fun updateMetaData(songInfo: SongInfo?) {
        ...
        val metaDta = MediaMetadataCompat.Builder()
            .putString(MediaMetadataCompat.METADATA_KEY_TITLE, songInfo.songName) //歌曲标题
            .putString(MediaMetadataCompat.METADATA_KEY_ARTIST, songInfo.artist) //歌手
            .putString(MediaMetadataCompat.METADATA_KEY_ALBUM, songInfo.songName) //专辑
            .putString(MediaMetadataCompat.METADATA_KEY_ALBUM_ARTIST, songInfo.artist) //专辑作者
            .putLong(MediaMetadataCompat.METADATA_KEY_DURATION, songInfo.duration)  //歌曲时长
        if (songInfo.coverBitmap != null) {
            metaDta.putBitmap(MediaMetadataCompat.METADATA_KEY_ALBUM_ART, songInfo.coverBitmap as Bitmap) //封面
        }
