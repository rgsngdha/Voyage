...
fun LocalDateTime.toInstant(zone: ZoneId = systemZoneId): Instant = atZone(zone).toInstant()

fun Instant.toLocalDateTime(zone: ZoneId = systemZoneId): LocalDateTime =
    LocalDateTime.ofInstant(this, zone)

fun LocalDateTime.toEpochSecond(zone: ZoneId = systemZoneId): Long = atZone(zone).toEpochSecond()
