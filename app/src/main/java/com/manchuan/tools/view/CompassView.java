...
public class CompassView extends View {
    ...
    public CompassView(Context context) {
        ...
        mCircumPaint.setColor(getContext().getResources().getColor(R.color.colorAccent));

        mOutSideCircumPaint = new Paint();
        mOutSideCircumPaint.setStyle(Paint.Style.FILL);
        mOutSideCircumPaint.setAntiAlias(true);
        mOutSideCircumPaint.setColor(0xffbfbfbf);
        ...
        mNorthPaint.setColor(getContext().getResources().getColor(R.color.colorAccent));

        mOthersPaint = new Paint();
        mOthersPaint.setStyle(Paint.Style.FILL);
        mOthersPaint.setAntiAlias(true);
        mOthersPaint.setTextSize(40);
        mOthersPaint.setColor(getContext().getResources().getColor(R.color.colorAccent));
        ...
        mCenterPaint.setTextSize(125);
        mCenterPaint.setColor(getContext().getResources().getColor(R.color.colorAccent));
        ...
        mSamllDegreePaint.setColor(0xffbfbfbf);
        ...
        mAnglePaint.setColor(getContext().getResources().getColor(R.color.colorAccent));
    ...
    private void drawInnerCricle() {
        ...
        mInnerShader = new RadialGradient(width / 2, mOutSideRadius + mTextHeight, mCircumRadius - 40, Color.parseColor("#00000000"),
